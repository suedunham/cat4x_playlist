...
function _thumbs() {
	...
	this.paint = (gr) => {
		...
		case !this.images.length:
			...
			gr.DrawString("Thumbs Panel:\nNo images to display", gdi.Font("Segoe Ui Semibold", 24, 0), _RGB(70, 70, 70), 0, 0, panel.w, panel.h, SF_CENTRE);
			break;
	...
	this.rbtn_up = (x, y) => {
		...
		panel.m.AppendMenuItem(utils.IsDirectory(this.folder) ? MF_STRING : MF_GRAYED, 1540, 'Open containing folder');
		panel.m.AppendMenuSeparator();
	}
