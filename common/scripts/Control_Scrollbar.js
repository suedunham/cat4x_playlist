/* This has been modified to resemble the way that WINE draws WinXP
   scrollbars with the colors provided to it via custom registry
   settings.
*/
...
function ScrollBar(x, y, w, h, row_h, fn_redraw) {
    this.paint = function (gr) {
        gr.FillSolidRect(this.x, this.y, this.w, this.h, g_theme.colors.scroll_back);
