...
function Playlist(x, y) {
    ...
    this.on_paint = function (gr) {
        ...
        if (this.items_to_draw.length) {
            ...
            gr.DrawString(text, g_theme.fonts.panel, g_theme.colors.panel_text_dim, this.x, this.y, this.w, this.h, g_string_format_center.value());
        }
...
function Header(parent, x, y, w, h, idx) {
    ...
    this.draw_normal_header = function (gr) {
        ...
        if (g_properties.show_group_info) {
            ...
            var sample = ((bitspersample > 16 || samplerate > 44100) ? ' ' + samplerate / 1000 + ' khz/' + bitspersample + '-bit' : '');
...
function Row(x, y, w, h, metadb, idx, cur_playlist_idx_arg) {
    ...
    this.draw = function (gr) {
        ...
        var title_artist_color = g_pl_colors.row_artist_normal;
        ...
        if (this.is_selected()) {
            ...
            title_artist_color = g_pl_colors.row_artist_selected;
        }
        ...
        if (this.is_playing) {// Might override 'selected' fonts
            ...
            title_artist_color = g_pl_colors.row_artist_playing;
        }
...
function PlaylistManager(x, y, w, h) {
    ...
    function draw_on_image(gr, x, y, w, h, panel_state) {
        ...
        gr.DrawString(info_text, g_pl_fonts.playlist_mgr, text_color, info_x, info_y, info_w, info_h, info_text_format.value());
    }
